<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalendarDetail.aspx.cs" Inherits="MyCalendar.CalendarDetail" %>
...
<body style="background-color: lightpink">
    ...
    <form id="form1" runat="server">
        <div class="col-lg-4">
            ...
            <div class="form-group">
                <label for="formGroupExampleInput2">Date End</label><br />
                <asp:TextBox ID="txtDateEnd" autocomplete="off" CssClass="form-control datetime" TextMode="DateTime" runat="server"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:Literal ID="lblWhom" runat="server"></asp:Literal>
            </div>
            <br />

            <div class="form-group">
                <label for="formGroupExampleInput2">With whom</label><br />
                <asp:TextBox ID="txtWhom"  CssClass="form-control" runat="server"></asp:TextBox>
            </div>

            <div class="form-group">
                <label for="formGroupExampleInput2">Description</label><br />
                <asp:Literal ID="lblDesc" runat="server"></asp:Literal>
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">New Description</label><br />
                <asp:TextBox ID="txtDesc"  CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
            </div>
            <br />
            <div style="text-align: center;">
                <asp:Button ID="btnCalendarDetail" CssClass="btn btn-primary" runat="server" Text="Save Changes" OnClick="btnCalendarDetail_Click" />
                <br />
                <br />
                <asp:Button ID="btnGoBackToMain" CssClass="btn btn-primary" runat="server" Text="Go Back To Main Page" OnClick="btnGoBackToMain_Click" />
            </div>
