<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordChange.aspx.cs" UnobtrusiveValidationMode="None" Inherits="MyCalendar.PasswordChange" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <label for="formGroupExampleInput">Current Password</label><br />
                <asp:TextBox CssClass="form-control" autocomplete="off" ID="CurrentPasswordTxt" runat="server" TextMode="Password"></asp:TextBox>
            </div>
            <br />
            <div class="form-group">
            ...
            <div style="text-align: center;">
                <asp:Button ID="SavePassBtn" CssClass="btn btn-primary" runat="server" Text="Save Changes" OnClick="SavePassBtn_Click" />
                <br />
                <br />
                <asp:Button ID="GoBackToMainBtn" CssClass="btn btn-primary" runat="server" Text="Go Back To Main Page" OnClick="GoBackToMainBtn_Click" />
            </div>
        </div>
    </form>
